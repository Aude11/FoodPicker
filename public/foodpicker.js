...
let drinks = ["Smoothie", "Beer", "Tea", "Coffee", "Water", "Ice cream", "Wine", "Iced oat latte", "Ice Tea", "Juice", "Hot chocolate", "Mule wine"];
let lunch = ["Risotto", "Pasta pesto", "Cheese & Bread", "Veggie Pizza", "Scramble egg", "Leek pie", "Salty cake"];
let diner = ["Paella", "Fish & Chips", "Sunday roast", "Burger", "Dahl", "Pad Thai" "Miso Soup", "Chicken salad", "Lasagne"];
