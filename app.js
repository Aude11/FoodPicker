...
let vegan = ["Avocado Toast", "Protein salad", "Lasagne vegan", "Ratatouille", "Salad of quinoa", "Vegan Maki", "Vegan pizza", "Tomato pie", "Mushroom burger", "Roasted Veggie"];
let veggie = vegan.concat(["Risotto", "Pasta pesto", "Cheese and Bread", "Veggie Pizza", "Scramble egg", "Leek pie", "Salty cake"]);
let healthy = ["Sushi", "Acai", "Avocado Toast", "Protein salad", "Scramble egg", "Smoothie", "Protein Bowl", "Chicken salad", "Lasagne vegan", "Ratatouille", "Salad of quinoa", "Vegan Maki"];
let classicMeal = ["Paella", "Fish and Chips", "Sunday roast", "Burger", "Dahl", "Pad Thai", "Miso Soup"];
let allMeal = veggie.concat(classicMeal);

let queryDefault = "London";
let defaultCity = queryDefault + " (default city as the input city does not match any cites)"
let units = "metric";
...
mongoose.connect("mongodb+srv://"+admin+":"+passwordDB+"@cluster0.ndyoh.mongodb.net/foodDB",{
